...
public class CustomScannerRegistrar implements ImportBeanDefinitionRegistrar, ResourceLoaderAware {
    //在SPRING_BEAN_BASE_PACKAGE扫描component注解的bean
    private static final String SPRING_BEAN_BASE_PACKAGE = "com.star";
    //以RpcScan注解中的basePackage变量为报名扫描rpcService注解的bean
